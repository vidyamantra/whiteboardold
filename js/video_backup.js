...
//				var remoteVideo = document.querySelector('#remoteVideo');
				...
				maybeStart : function() {
					if (!cthis.isStarted && cthis.localStream && cthis.isChannelReady) {
						...
						cthis.pc.addStream(cthis.localStream);
				...
				createPeerConnection : function () {
				  try {
				    cthis.pc = new RTCPeerConnection(this.pc_config, this.pc_constraints);
				    cthis.pc.onicecandidate = cthis.handleIceCandidate;
				  ...
				  cthis.pc.onaddstream = cthis.handleRemoteStreamAdded;
				  cthis.pc.onremovestream = cthis.handleRemoteStreamRemoved;
				}, 
				...
				doCall : function() {
				  ...
				  cthis.pc.createOffer(this.setLocalAndSendMessage, null, constraints);
				}, 

				doAnswer:  function () {
				  console.log('Sending answer to peer.');
				  cthis.pc.createAnswer(this.setLocalAndSendMessage, null, this.sdpConstraints);
				},
				...
				mergeConstraints : function(cons1, cons2) {
				 ...
				 setLocalAndSendMessage : function(sessionDescription) {
				  ...
				  cthis.pc.setLocalDescription(sessionDescription);
...
//					}
				  ...
				  if (message === 'got user media') {
				    ...
				    cthis.pc.setRemoteDescription(new RTCSessionDescription(message));
				    cthis.doAnswer();
				    ...
				    cthis.pc.addIceCandidate(candidate);
